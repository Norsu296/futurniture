            ...
            <div class="details">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-success">10</h5>
                                <p class="card-text">Zamówienia w realizacji</p>
                                <a href="#" class="btn btn-success">Podgląd</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="#" class="btn btn-danger">Podgląd</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="#" class="btn btn-primary">Podgląd</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tr>
                        ...
                        <td>information</td>
                        <td>placeholder</td>
                        <td>illustrative</td><script src="../assets/dist/js/bootstrap.bundle.min.js"></script>
                        <td>data</td>
                    </tr>
                    <tr>
                        <td>1,004</td>
